            ...
            <div class="row gx-4">
                ...
                <div class="col-lg-5">
                    ...
                    <div class="card">
                            ...
                            <form action="<?php echo e(route('tracking.store')); ?>" method="POST"enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="card-body">
                                <div class="mb-3">
                            ...
                            <div class="row">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        <td>
                                          <span class="badge bg-<?php echo e($array == 0 ? 'success' : 'white text-dark'); ?>"><?php echo e($tracking->status); ?></span>
                                        </td>
                                        <td><?php echo e($tracking->keterangan); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\OneDrive\Documents\surat-app\resources\views/pages/admin/batch/show.blade.php ENDPATH**/ ?>
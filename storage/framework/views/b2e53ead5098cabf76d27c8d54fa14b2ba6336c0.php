        ...
        <div class="container-fluid px-4">
            <div class="row gx-4">
                ...
                <div class="col-lg-5">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Perbarui status tracking</h5>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Project\surat-app\resources\views/pages/admin/batch/show.blade.php ENDPATH**/ ?>
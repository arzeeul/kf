...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e($item->bets_received); ?>" name="bets_received" required>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="file"
                                            class="form-control <?php $__errorArgs = ['bets_file'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e($item->bets_file); ?>" name="bets_file"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\OneDrive\Documents\surat-app\resources\views/pages/admin/letter/edit.blade.php ENDPATH**/ ?>
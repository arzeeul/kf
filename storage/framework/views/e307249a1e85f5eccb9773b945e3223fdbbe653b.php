                ...
                <div class="page-header-content">
                    <div class="row align-items-center justify-content-between pt-3">
                        ...
                        <div class="col-12 col-xl-auto mb-3">
                            <a class="btn btn-sm btn-light text-primary" href="<?php echo e(route('arsip')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e(old('bets_no')); ?>" name="bets_no" placeholder="Nomor Bets.."
                                            required>
                                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\OneDrive\Documents\surat-app\resources\views/pages/admin/letter/create.blade.php ENDPATH**/ ?>
                ...
                <div class="col-lg-12">
                    <div class="card card-header-actions mb-4">
                        <div class="card-header">
                            List Batch Record
                            <a class="btn btn-sm btn-primary" href="<?php echo e(route('batch.create')); ?>">
                                Tambah Batch
                            </a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <?php $__currentLoopData = $batch; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo e(route('batch.destroy', $item->id)); ?>" id="delete"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\OneDrive\Documents\surat-app\resources\views/pages/admin/batch/index.blade.php ENDPATH**/ ?>
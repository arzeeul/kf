                ...
                <div class="col-lg-12">
                    <div class="card card-header-actions mb-4">
                        <div class="card-header">
                            List Arsip
                            <a class="btn btn-sm btn-primary" href="<?php echo e(route('letter.create')); ?>" target="_blank">
                                Tambah Arsip
                            </a>
                        </div>
                        <div class="card-body">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\OneDrive\Documents\surat-app\resources\views/pages/admin/letter/incoming.blade.php ENDPATH**/ ?>